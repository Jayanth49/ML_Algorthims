# -*- coding: utf-8 -*-
"""
Created on Fri Jan 29 22:58:32 2021
...
def detect(original_image, min_score, max_overlap, top_k, suppress=None):
 ...
 # read as PIL image
img_path = 'D:/GitHub/Introductory_excersices_ml/Deep_Learning/vision_concepts-and-Projects/SSD/SSD/000002.jpg'
original_image = Image.open(img_path, mode='r')
# conver to RGB color format
original_image = original_image.convert('RGB')
# get the output as PIL image
pil_image_out = detect(original_image, min_score=45, max_overlap=0.5, top_k=200)
...
save_name = 'arey'
cv2.imwrite(f"save_name", result_np)
