...
class VGGBase(nn.Module):
    ...
    def load_pretrained_layers(self):
        ...
        state_dict['conv6_weight'] = decimate(conv_fc6_weight, m=[4, None, 3, 3]) # (1024, 512, 3, 3)
        state_dict['conv6.bias'] = decimate(conv_fc6_bias, m=[4]) # 1024
        
        #fc7
        conv_fc7_weight = pretrained_state_dict['classifier.3.weight'].view(4096,4096,1,1)
        conv_fc7_bias = pretrained_state_dict['classifier.3.bias']
        state_dict['conv7_weight'] = decimate(conv_fc7_weight,m=[4,4,None,None]) # 1024,1024,1,1
        state_dict['conv7_bias'] = decimate(conv_fc7_bias,m=[4]) #1024
...
class AuxiliaryConvolutions(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv8_2 = nn.Conv2d(256,512,kernel_size=3,stride=2,padding=1) # dim reduces as stride as > 1
        
        self.conv9_1 = nn.Conv2d(512,128,kernel_size=1,padding=0)
        self.conv9_2 = nn.Conv2d(128,256,kernel_size=3,stride=2,padding=1) # similar as above
        
        self.conv10_1 = nn.Conv2d(256,128,kernel_size=1,padding=0)
        self.conv10_2 = nn.Conv2d(128,256,kernel_size=3,padding=0) # dims reduces as padding is  zero
        
        self.conv11_1 = nn.Conv2d(256,128,kernel_size=1,padding=0)
        self.conv11_2 = nn.Conv2d(128,256,kernel_size=3,padding=0) # similar as above 
...
class PredictionConvolutions(nn.Module):
    ...
    def __init__(self,n_classes):
        ...
        def forward(self,conv4_3_feats,conv7_feats,conv8_2_feats,conv9_2_feats,conv10_2_feats,conv11_2_feats):
            ...
            # predict localization boxes bounds (offsets wrt to bounding boxes):
            ...
            l_conv10_2 = l_conv10_2.permute(0,2,3,1)  # (N, 3, 3, 16)
            l_conv10_2 = l_conv10_2.view(batch_size,-1,4) # (N, 36, 4)
            
            l_conv11_2 = self.loc_conv11_2(conv11_2_feats) # (N, 16, 1, 1)
            l_conv11_2 = l_conv11_2.permute(0,2,3,1) # (N, 1, 1, 16)
            l_conv11_2 = l_conv11_2.view(batch_size,-1,4) # (N, 4, 4)
            
            #predicting classes in localised boxes
            ...
            class_scores = torch.cat([c_conv4_3, c_conv7, c_conv8_2, c_conv9_2, c_conv10_2, c_conv11_2],dim=1)  # (N, 8732, n_classes)
                        ...
                        for ratio in aspect_ratios[fmap]:
                            ...
                            if ratio ==1:
                                try:
                                    ...
                                    # at the end there will be not k+1
                                except IndexError:
                                    additional_scale = 1.
