# -*- coding: utf-8 -*-
"""
Created on Fri Jan 29 23:29:06 2021
...
if __name__ == '__main__':
    path = 'D:/GitHub/Introductory_excersices_ml/Deep_Learning/vision_concepts-and-Projects/SSD/SSD/vid1.mp4'
    ...
    while(cap.isOpened()):
        ...
        if ret == True:
            ...
            pil_image_out = detect(pil_image_in, min_score=45, max_overlap=0.5, top_k=200)
            # get the end time
            end_time = time.time()
